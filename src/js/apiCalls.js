/**
 * The Socrata 4x4 identifier for the dataset on DataSF
 * @type {string}
 */
const DATASOURCE = '75rg-imyz'

/** @function whereArray
 * form the 'where array' that goes into formQueryString
 ...
 * query sfdata for a parcel or parcels
 ...
 * @returns {consumer} some sort of promise
 */
